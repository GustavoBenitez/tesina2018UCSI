 ...
 * @author Rojeru San
 */
public class WarningAlertDepar extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WarningAlertDepar(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        String tabla="DEPARTAMENTO", evento="DELETE", hora=nuevoPrincipal.lblHora.getText(), fecha=nuevoPrincipal.lblFechaAc.getText();
        int elimina = FuncionesDC.eliminar(Integer.parseInt(this.id.getText()));
        if (elimina != 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertDepar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertDepar dialog = new WarningAlertDepar(new javax.swing.JFrame(), true);
